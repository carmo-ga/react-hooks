// Aula do dia 30/03/2021 Parte I e Parte II
...
function PokemonInfo({pokemonName}) {
    ...
    */
    ...
    React.useEffect(() => {
        ...
        //if(status === 'idle') return   // Nome vazio, retorna sem fazer nada
        ...
        */
        ...
        // Callback é uma função que será executada pela função assíncrona assim que ela tiver terminado de fazer sua tarefa

        // Tecnicamente, uma função assíncrona retorna um objeto do tipo Promise (promessa).
        // Uma Promise suporta dois callbacks, um para quando a execução assíncrona dá certo e outro para o caso de erro.
        /*
